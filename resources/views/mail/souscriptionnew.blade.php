                                                    ...
                                                    <tr>
                                                        <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                                            <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                                                Un client vient d'envoyer une demande d'abonnement <br> <br>
                                                                <div style="text-align:left;margin-left: 20px;">
                                                                    <p style="color: #000000;font-size: large;">Nom : {{ $fullname }}</p>
                                                                    <p style="color: #000000;font-size: large;">Numero : {{ $num_client }}</p>
                                                                    <p style="color: #000000;font-size: large;">Email : {{ $email_client }}</p>
