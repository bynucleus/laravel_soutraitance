...
<![endif]-->
        <div style='margin:0px auto;max-width:600px;'>
            <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='width:100%;'>
                <tbody>
                    <tr>
                        <td style='border-bottom:2px solid #EE008C;border-top:2px solid #EE008C;direction:ltr;font-size:0px;padding:10px;text-align:center;vertical-align:top;'>
                            <!--[if mso | IE]>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                                            <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                                                Bonjour {{ $fullname }}, Merci d'avoir effectué votre achat sur notre boutique<br> nous vous contacterons dans peu pour finaliser.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                        ...
                                                        <tr>
                                                            <td style='background-color:#ffffff;border:1px solid #e5e5e5;padding:15px;vertical-align:top; '>
                                                                <table border='0 ' cellpadding='0 ' cellspacing='0 ' role='presentation ' style=' ' width='100% '>
                                                                    ...
                                                                    <tr>
                                                                        @php $adresse=\DB::table('adresses')->where('id', \DB::table('commandes')->where('id',$id_commande)->first()->id_adr)->first(); $commune=\DB::table('communes')->where('code',$adresse->code_commune)->first(); $ville=\DB::table('villes')->where('code',$commune->code_ville)->first(); @endphp
                                                                        <td align='left ' style='font-size:0px;padding:0px;word-break:break-word; '>
                                                                            <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:23px;text-align:left; '>
                                                                                {{$ville->nom}}, {{$commune->nom}}, <br> {{$adresse->description}}
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                ...
                                <table border='0 ' cellpadding='0 ' cellspacing='0 ' role='presentation ' style='vertical-align:top; ' width='100% '>
                                    <tr>
                                        <td align='left ' style='font-size:0px;padding:10px 25px;word-break:break-word; '>
                                            <table border='0 ' cellpadding='0 ' cellspacing='0 ' style="cellpadding:0;cellspacing:0;color:#777777;font-family:'Oxygen ', 'Helvetica Neue
                                                                    ', helvetica, sans-serif;font-size:14px;line-height:21px;table-layout:auto;width:100%;" width='100% '>
                                                <tr>
                                                        ...
                                                        <table cellpadding='0 ' cellspacing='0 ' style="font-size:14px; line-height:19px; font-family: 'Oxygen ', 'Helvetica Neue ', helvetica, sans-serif;" width='100% '>
                                                            <tbody>
                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td style='width:110px; '>
                                                                                        <a href='# ' target='_blank '>
                                                                                            <img alt='item1 ' height='auto ' src='httpsatAAH1E_item_images_19.jpg ' style='border: 1px solid #e6e6e6;border-radius:4px;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;
                                                                    ' width='110 ' />
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                    ...
                                                                    @php
                                                                    $type_paye = $detail->type_paye;
                                                                    $text = "achat";
                                                                    if($type_paye=="louer1") $text = "location de 15 jours";
                                                                    else if($type_paye=="louer2") $text = "location de 1 mois";
                                                                    else $text = "achat";
                                                                    @endphp
                                                                    <td style="text-align:left; font-size:14px; line-height:19px; font-family: ' oxygen ', 'helvetica neue ', helvetica, sans-serif; color: #777777;">
                                                                        <span style='color: #4d4d4d; font-weight:bold; '>
                                                                            {{$prod->nom}}@if($text!="achat") ({{$text}}) @endif
                                      </span>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                ...
                                Sous Total
                                                    ...
                                                    <td style='text-align: right; border-top: 1px solid #cccccc; '>
                                                        <span style='padding:8px 0px; display: inline-block; '>
                                                            {{intval($montant)-intval($commande->prix_livraison) }} Fcfa
                              </span>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td valign='top '>
                                                                                                    <a href='# Facebook ' style='text-decoration:none; ' target='_blank '>
                                                                                                        <img alt='Facebook ' border='0 ' height='26 ' src='https://www.sendwithus.com/assets/img/emailmonks/images/fb.png ' style='display:block;font-family:
                                                                    Arial, sans-serif; font-size:10px; line-height:18px; color:#EE008C; ' width='26 ' />
                                                                                                    </a>
                                                                                                </td>
                                                                                                <td width='7 '>
                                                                                                    &nbsp;
                                                                                                ...
                                                                                                <td valign='top '>
                                                                                                    <a href='# Twitter ' style='text-decoration:none; ' target='_blank '>
                                                                                                        <img alt='Twitter ' border='0 ' height='26 ' src='https://www.sendwithus.com/assets/img/emailmonks/images/tw.png ' style='display:block;font-family:
                                                                    Arial, sans-serif; font-size:10px; line-height:18px; color:#EE008C; ' width='26 ' />
                                                                                                    </a>
                                                                                                </td>
                                                                                                <td width='7 '>
                                                                                                ...
                                                                                                <td valign='top '>
                                                                                                    <a href='# Instagram ' style='text-decoration:none; ' target='_blank '>
                                                                                                        <img alt='Instagram ' border='0 ' height='26 ' src='https://www.sendwithus.com/assets/img/emailmonks/images/insta.png ' style='display:block;font-family:
                                                                    Arial, sans-serif; font-size:10px; line-height:18px; color:#EE008C; ' width='26 ' />
                                                                                                    </a>
                                                                                                </td>
                                                                                                <td width='7 '>
